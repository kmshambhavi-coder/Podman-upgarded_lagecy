# 28AWS GuardDuty - Findings Connector
...
|AWS Default Region|AWS default region to use in integration, for example us-west-2.|True|fdsa|
|Detector ID|ID of the detector. It can be found in the "Settings" tab.|True|gfds|
