# 55VMware Carbon Black Cloud Alerts and Events Tracking Connector
...
|API Root|Vmware Carbon Black Cloud API Root URL|True|jhgfds|
|Organization Key|Vmware Carbon Black Cloud Organization Key, Eg. 7DDDD9DD|True|hgfds|
