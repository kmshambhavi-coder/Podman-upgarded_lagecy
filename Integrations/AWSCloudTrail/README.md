...
|Alert Severity|Severity of the Siemplify Alerts created based on the insights. Possible values: Informational, Low, Medium, High, Critical|True|None|Medium|
|Max Insights To Fetch|How many insights to process per one connector iteration. Maximum is 50.|False|None|50|
...
|Verify SSL|If enabled, verify the SSL certificate for the connection to the AWS Cloud Trail server is valid.|False|None|false|
