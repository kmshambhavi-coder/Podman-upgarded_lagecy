...
|AWS Region|Optionally specify the AWS Region to be used in the action that can be different from the default region specified in the integration configuration page.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Enable|Specifies whether the detector is to be enabled||Boolean|false|
...
|Finding Types|The types of sample findings to generate. Comma separated values. If empty, example findings of all supported finding types will be generated. Types can be found in the UI at ‘Findings’ section under ‘Finding Type’ column||String||
...
|Active|If enabled, the newly created Threat Intelligence Set will be activated.||Boolean|true|
|Tags|Specify additional tags that should be added to the Threat Intelligence Set. Format: key_1:value_1,key_2:value_1.||String||
...
|Max Trusted IP Lists To Return|Specify how many Trusted IPs lists to return. Default is 50.||String|50|
|AWS Region|Optionally specify the AWS Region to be used in the action that can be different from the default region specified in the integration configuration page.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Max Detectors To Return|Specify how many detectors to return. Default is 50.||String|50|
...
|----|-----------|-----------|----|------------|
|Detector ID|The unique ID of the detector that you want to retrieve.|True|String||
|Max Findings To Return|Specify how many detectors to return. Default is 50.||String|50|
|Sort By|Represents the finding attribute (for example, accountId) to sort findings by.||String||
|Order By|The order by which the sorted findings are to be displayed.||List||
|AWS Region|Optionally specify the AWS Region to be used in the action that can be different from the default region specified in the integration configuration page.||String||
...
|Name|Specify the new name of the Trusted IP List.||String||
|File Location|Specify a new URI location, where the file is located.||String|https://s3.amazonaws.com/{bucket-name}/file.txt|
|Activate|If enabled, the Trusted IP List will be activated.||Boolean|true|
|AWS Region|Optionally specify the AWS Region to be used in the action that can be different from the default region specified in the integration configuration page.||String||
...
|Max Threat Intelligence Sets To Return|Specify how many threat intelligence sets to return. Default is 50.||String|50|
|AWS Region|Optionally specify the AWS Region to be used in the action that can be different from the default region specified in the integration configuration page.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Enable|Specifies whether the detector should be enabled||Boolean|false|
...
|Name|Specify the new name of the Threat Intelligence Set.||String||
|File Location|Specify a new URI location, where the file is located.||String|https://s3.amazonaws.com/{bucket-name}/file.txt|
|Active|If enabled, the Threat Intelligence Set will be activated.||Boolean|true|
...
|File Location|Specify the URI location, where the file is located.|True|String|https://s3.amazonaws.com/{bucket-name}/file.txt|
|Activate|If enabled, the newly created Trusted IP List will be activated.||Boolean|true|
|AWS Region|Optionally specify the AWS Region to be used in the action that can be different from the default region specified in the integration configuration page.||String||
