...
|----|-----------|-----------|----|------------|
|Api key|The API key is used to create the connection with airtable||Password|*****|
|Base id|.||String|None|
...
|Sort by|The column name you would like to sort by||String|<column_name>|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Enrichment Prefix|Prefix to use for entity enrichment||String|AT_|
|Max records|The maximum records (rows) that will be affected by the action||String|100|
...
|Entity Field|Entity field to used for AirTable search (Can be Identifier or any other enrichment field). Default is Identifier||String|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Alert name field|Determines the Alert name based on the airtable column name defined in the parameter||String|<alert_name_field>|
|Alert name prefix|The alert name prefix||String|<alert_name_prefix>|
...
|Field name|The field name that you would like to search the value by||String|<field_name>|
|Field value|The value that you would like to search for under the relevant field name||String|<field_value>|
