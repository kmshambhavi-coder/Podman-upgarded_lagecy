...
|Site IDs|Specify a comma-separated list of site ids, where hash needs to be sent to the blacklist.||String||
|Group IDs|Specify a comma-separated list of group ids, where hash needs to be sent to the blacklist.||String||
|Account IDs|Specify a comma-separated list of account ids, where hash needs to be sent to the blacklist.||String||
|Description|Specify additional information related to the hash.||String||
|Add to global black list|If enabled, action will add the hash to the global blacklist. Note: when this parameter is enabled, parameters “Site IDs“, “Group IDs“ and “Account IDs“ are ignored.||Boolean|False|
...
|Site IDs|Specify a comma-separated list of site ids, where hash needs to be sent to the exclusion list.||String||
|Group IDs|Specify a comma-separated list of group ids, where hash needs to be sent to the exclusion list.||String||
|Account IDs|Specify a comma-separated list of account ids, where hash needs to be sent to the exclusion list.||String||
|Description|Specify additional information related to the hash.||String||
|Add to global exclusion list|If enabled, action will add the hash to the global exclusion list. Note: when this parameter is enabled, parameters “Site IDs“, “Group IDs“ and “Account IDs“ are ignored.||Boolean||
...
|Site IDs|Specify a comma-separated list of site ids, where path needs to be sent to the exclusion list.||String||
|Group IDs|Specify a comma-separated list of group ids, where path needs to be sent to the exclusion list.||String||
|Account IDs|Specify a comma-separated list of account ids, where path needs to be sent to the exclusion list.||String||
|Description|Specify additional information related to the path.||String||
|Add to global exclusion list|If enabled, action will add the path to the global exclusion list. Note: when this parameter is enabled, parameters “Site IDs“, “Group IDs“ and “Account IDs“ are ignored.||Boolean|False|
|Include Subfolders|If enabled, action will include subfolders for the provided path. This feature only works, if user provides folder path and not file path.||Boolean||
|Mode|Specify what mode should be used for the excluded path.||List|Suppress Alerts|
...
|Scope Type|Scope type in which the alert is available.||List|Account|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Site IDs|Specify a comma-separated list of site ids, from where the hash needs to be removed.||String||
|Group IDs|Specify a comma-separated list of group ids, from where the hash needs to be removed.||String||
|Account IDs|Specify a comma-separated list of account ids, from where the hash needs to be removed.||String||
|Remove from global black list|If enabled, action will remove the hash from the global black list. Note: when this parameter is enabled, parameters "Site IDs", "Group IDs" and "Account IDs" are ignored.||Boolean|false|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Create Insight|If enabled, action will create an insight with information about endpoints.||Boolean|true|
|Only Infected Endpoints Insights|If enabled, action will only create insights for the infected endpoints.||Boolean|true|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Max Applications To Return|Specify how many applications to return. If nothing is specified action will return all of the applications.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Hash|Specify a comma-separated list of hashes that need to be checked in blacklist. Only hashes that were found will be returned. If nothing is specified here action will return all hashes. Note: if "Hash" parameter is provided then "Limit" parameter is ignored.||String||
|Site IDs|Specify a comma-separated list of site ids, which should be used to return blacklist items.||String||
|Group IDs|Specify a comma-separated list of group ids, which should be used to return blacklist items.||String||
|Account IDs|Specify a comma-separated list of account ids, which should be used to return blacklist items.||String||
|Limit|Specify how many blacklist items should be returned. Note: if "Hash" parameter has values, then this parameter is ignored. Maximum is 1000.||String|50|
|Query|Specify the query that needs to be used in order to filter the results.||String||
|Use Global Blacklist|If enabled, action will also return hashes from the global blacklist.||Boolean|False|
...
|Limit|Specify how many events to return. Default: 50. Maximum is 100.||String|50|
...
|Events Amount Limit|Specify how many events to return per event type. Default: 50.||String|50|
|Include File Events Information|If enabled, action will also query information about file events.||Boolean|false|
|Include Indicator Events Information|If enabled, action will also query information about indicator events.||Boolean|false|
|Include DNS Events Information|If enabled, action will also query information about DNS events.||Boolean|false|
|Include Network Actions Events Information|If enabled, action will also query information about “network actions” events.||Boolean|false|
|Include URL Events Information|If enabled, action will also query information about URL events.||Boolean|false|
|Include Registry Events Information|If enabled, action will also query information about registry events.||Boolean|false|
|Include Scheduled Task Events Information|If enabled, action will also query information about scheduled task events.||Boolean|false|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Reputation Threshold|Specify what should be the reputation threshold in order it to be marked as suspicious. If nothing is provided, action will not mark entites as suspicious. Maximum: 10.||String|5|
|Create Insight|If enabled, action will create an insight containing information about the reputation.||Boolean|true|
|Only Suspicious Hashes Insight|If enabled, action will only create insight for hashes that have higher or equal reputation to “Reputation Threshold“ value.||Boolean|true|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Mitigation Status|Specify the comma-separated list of threat statuses. Only threats that match the statuses will be returned. Possible values: mitigated, active, blocked, suspicious, suspicious_resolved||String||
|Created until|Specify the end time for the threats. Example: 2020-03-02T21:30:13.014874Z||String||
|Created from|Specify the start time for the threats. Example: 2020-03-02T21:30:13.014874Z||String||
|Resolved Threats|If enabled, action will only return resolved threats.||Boolean|false|
|Threat Display Name|Specify a display name of the threat that you want to return. Partial name will also work.||String||
|Limit|Specify how many threats to return. Default: 10.||String|10|
|API Version|Specify what version of API to use in the action. If nothing is provided connector will use version 2.1. Note: JSON result structure is different between API versions. It is recommended to use the latest one.||List|2.0|
...
|Start Date|Specify the start date for the search. If nothing is specified, action will fetch events from 30 days ago.||String||
|End Date|Specify the end date for the search. If nothing is specified, action will use current time.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Filter Key|Specify the key that needs to be used to filter sites.||List|Select One|
...
|Max Records To Return|Specify how many records to return.||String|50|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Group ID|Specify the ID of the group, where to move the agents.||String||
|Group Name|Specify the name of the group, where to move the agents. Note: if both Group ID and Group Name are provided, action will put “Group ID“ in the priority.||String||
...
|Annotation|Specify an annotation describing, why the threat can be resolved.||String||
...
|Status Filter|Comma-separated list of status that should be ingested. Possible values: Unresolved, In Progress, Resolved. If nothing is provided, the connector will fetch alerts with statuses Unresolved and InProgress.||String|Unresolved, In Progress|
...
|Lowest Severity To Fetch|Lowest severity of the alerts to fetch. If nothing is provided, the connector will ingest alerts with all severities. Possible Values: Info, Low, Medium, High, Critical.||String||
...
|Verify SSL|If enabled, verify the SSL certificate for the connection to the SentinelOne server is valid.||Boolean|true|
...
|EventClassId|Enter the source field name in order to retrieve the Event Field name.||String|threatinfo_classification|
...
|API Token|SentinelOne API token.|True|Password|*****|
|Verify SSL|If enabled, verify the SSL certificate for the connection to the Sentinel public cloud server is valid.||Boolean|TRUE|
...
|Event Object Type Filter|A comma-separated list of event objects that need to be returned alongside threat info. This parameter is used as a filter to only return certain objects. Examples: process,ip,indicators. If nothing is provided, the connector will ingest all event object types.||String||
|Event Type Filter|A comma-separated list of event types that need to be returned alongside threat info. This parameter is used as a filter to only return certain event types. Examples: Process Creation, Behavioral Indicators.||String||
|Max Events To Return|How many events to return per threat. Maximum: 199.||Integer|199|
...
|Proxy Username|The proxy username to authenticate with.||String||
|Proxy Password|The proxy password to authenticate with.||Password|*****|
|API Version|Specify what version of api to use in the connector. If nothing is provided connector will use version 2.1. Note: Siemplify Event structure is different between API versions. It is recommended to use the latest one. Possible values: 2.0, 2.1.||String|2.0|
