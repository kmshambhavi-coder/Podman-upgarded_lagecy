...
|----|------|-----------|
|01Playbook1- block and widget|Default||
|02Playbook1- block and widget|Default||
|1Different environment|Default||
|7 Different environment - 2|Default||
|Block1|Default|An embedded workflow that can receive inputs and return an output.|
